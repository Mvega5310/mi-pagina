  ...
  return (
    <>
      ...
      {isHomePage ? (
        ...
        <header className="fixed top-7 md:top-9 left-0 right-0 z-[60] border border-[#FFFFFF1A] bg-gradient-to-r from-[#70A7FF]/30 via-[#6079FD]/30 to-[#565CFC]/30 backdrop-blur-md text-white">
