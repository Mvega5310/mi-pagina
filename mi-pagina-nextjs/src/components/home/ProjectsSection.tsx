...
const projectsData = [
  {
    id: 1,
    image: '/images/home/section5-image1.jpg',
    categoryColor: 'bg-blue-100 text-blue-600'
  },
  {
    id: 2,
    image: '/images/home/section5-image2.jpg',
    categoryColor: 'bg-green-100 text-green-600'
  },
  {
    id: 3,
    image: '/images/home/section5-image3.jpg',
    categoryColor: 'bg-purple-100 text-blue-600'
  },
  {
    id: 4,
    image: '/images/home/section5-image4.jpg',
...
const ProjectsCarousel = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setCurrentSlide((prev) => (prev + 1) % Math.ceil(projectsData.length / itemsPerSlide))
