    ...
    <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
            ...
            <div className="flex flex-col sm:flex-row space-y-1 sm:space-y-0 sm:space-x-1 bg-gray-100 p-1 rounded-lg">
              {['mission', 'vision', 'history'].map((tab) => (
                <motion.button
                  ...
                  className={`flex-1 px-3 sm:px-4 py-2 sm:py-3 rounded-md text-xs sm:text-sm md:text-base font-medium transition-all duration-200 ${activeTab === tab
          ...
          <motion.div className="mt-4 lg:mt-0 space-y-4 sm:space-y-6" variants={itemVariants}>
            <div>
              <h3 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mb-3 sm:mb-4">
        ...
        >
          <div className="relative w-full max-w-7xl mx-auto">
            <div className="relative overflow-hidden shadow-2xl h-64 sm:h-80 md:h-96 lg:h-[410px] rounded-lg">
              {/* Background Image */}
              <Image
                src="/images/home/section4-image1.webp"
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4 sm:px-6 lg:px-8">
                ...
                <motion.button
                  className="bg-gray-900 hover:bg-black text-white px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 font-semibold text-sm sm:text-base lg:text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-4 focus:ring-white/50 rounded-md"
