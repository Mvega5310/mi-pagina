...
"[project]/Documents/work/person/mi-pagina-old/mi-pagina-nextjs/src/components/home/ProjectsSection.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const transformProjectsData = (t)=>{
    const projectsData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$src$2f$utils$2f$projectsDataGenerator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateProjectsData"])(t);
    return projectsData.map((project, index)=>{
        return {
            ...
            categoryColor: (project === null || project === void 0 ? void 0 : project.color) || 'bg-gray-100 text-gray-600'
        };
    });
};
...
const ProjectsCarousel = ()=>{
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const [currentPage, setCurrentPage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const [isTransitioning, setIsTransitioning] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [mobileActiveTab, setMobileActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectsCarousel.useEffect": ()=>{
            if (!isAutoPlaying) return;
            const goToNext = {
                "ProjectsCarousel.useEffect.goToNext": ()=>{
                    if (isTransitioning) return;
                    setIsTransitioning(true);
                    setCurrentPage({
                        "ProjectsCarousel.useEffect.goToNext": (prev)=>(prev + 1) % 3
                    }["ProjectsCarousel.useEffect.goToNext"]);
                    setTimeout({
                        "ProjectsCarousel.useEffect.goToNext": ()=>setIsTransitioning(false)
                    }["ProjectsCarousel.useEffect.goToNext"], 300);
                }
            }["ProjectsCarousel.useEffect.goToNext"];
            const interval = setInterval({
                "ProjectsCarousel.useEffect.interval": ()=>{
                    goToNext();
                }
            }["ProjectsCarousel.useEffect.interval"], 5000); // Change page every 5 seconds
            return ({
                "ProjectsCarousel.useEffect": ()=>clearInterval(interval)
            })["ProjectsCarousel.useEffect"];
        }
    }["ProjectsCarousel.useEffect"], [
        isAutoPlaying,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: getCurrentPageProjects().map((project, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "flex-1 py-2 px-3 text-xs font-medium rounded-md transition-all duration-200 ".concat(mobileActiveTab === index ? 'bg-white text-[#7B43D6] shadow-sm' : 'text-gray-600 hover:text-gray-900'),
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "inline-block ".concat(getCurrentPageProjects()[mobileActiveTab].categoryColor, " text-xs font-semibold px-3 py-1 mb-3 uppercase tracking-wide rounded-full"),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-12 transition-all duration-300 ".concat(isTransitioning ? 'opacity-75 scale-95' : 'opacity-100 scale-100'),
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "inline-block ".concat(project.categoryColor, " text-xs font-semibold px-2 sm:px-3 py-1 mb-2 sm:mb-3 uppercase tracking-wide rounded-full"),
                                            children: project.category
                                        }, void 0, false, {
                                            fileName: "[project]/Documents/work/person/mi-pagina-old/mi-pagina-nextjs/src/components/home/ProjectsSection.tsx",
                                            lineNumber: 162,
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            1,
                            2
                        ].map((pageIndex)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: ()=>{
                                    goToPage(pageIndex);
                                ...
                                className: "w-3 h-3 rounded-full transition-all duration-300 ".concat(pageIndex === currentPage ? 'bg-[#7B43D6] scale-125' : 'bg-[#A8A8B8] hover:bg-[#8B8B9A] hover:scale-110', " disabled:opacity-50 disabled:cursor-not-allowed"),
...
_s(ProjectsCarousel, "Sl4/VqQofFa2Ez0G5qerGDdTGGQ=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = ProjectsCarousel;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProjectsCarousel, {}, void 0, false, {
                    fileName: "[project]/Documents/work/person/mi-pagina-old/mi-pagina-nextjs/src/components/home/ProjectsSection.tsx",
                    lineNumber: 233,
                    columnNumber: 9
                }, ("TURBOPACK compile-time value", void 0))
...
_s1(ProjectsSection, "zlIdU9EjM2llFt74AbE2KsUJXyM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$work$2f$person$2f$mi$2d$pagina$2d$old$2f$mi$2d$pagina$2d$nextjs$2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$useTranslation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"]
    ];
});
...
//# sourceMappingURL=Documents_work_person_mi-pagina-old_mi-pagina-nextjs_src_3da4ebb6._.js.map