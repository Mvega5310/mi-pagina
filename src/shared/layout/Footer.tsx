  ...
  return (
    <footer className="bg-[#1F0951] text-white py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <img src={bgFooter} alt="Background" className="h-full object-contain" width={1200} height={400} loading="lazy" />
      </div>
      
      <div className="container mx-auto px-20 relative z-10">
        {/* Logo and social media at top */}
        <div className="flex justify-between items-center mb-12">
          <img src={logoWhite} alt="Friendsoft" className="h-10" width={120} height={40} loading="eager" />
          ...
          <div className="flex space-x-4" role="list" aria-label="Social media links">
            ...
            >
              <img src={x} alt="" className="h-5 w-5" width={20} height={20} loading="lazy" />
            </a>
            <a 
            ...
            >
              <img src={facebook} alt="" className="h-5 w-5" width={20} height={20} loading="lazy" />
            </a>
            <a 
            ...
            >
              <img src={instagram} alt="" className="h-5 w-5" width={20} height={20} loading="lazy" />
            </a>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 pt-4">
          <div className="text-sm text-gray-400">
            ...
            <img src={logoWhite} alt="Friendsoft" className="h-4 inline-block ml-1" width={60} height={16} loading="lazy" />
          </div>
        </div>
      </div>
    </footer>
