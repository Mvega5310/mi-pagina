      ...
      <div className="relative mb-16 lg:mb-24">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="relative flex justify-center items-center min-h-[300px] lg:min-h-[400px]">
            {/* Background Image */}
            <div 
              className="absolute inset-0 bg-center bg-no-repeat bg-contain bottom-16 md:bottom-0 md:left-24"
            ...
            <div className="relative z-10 -top-12">
              <h2 
                className="text-[60px] md:text-[180px] lg:text-[200px] font-bold leading-[0.8] lg:leading-[265px] text-transparent bg-clip-text select-none"
                style={{
            ...
            {progressBars.map((item, index) => (
              <div key={index} className="space-y-3">
                ...
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div 
                    className="bg-gradient-to-r from-[#70A8FF] to-[#565CFD] h-3 rounded-full transition-all duration-1000 ease-out"
