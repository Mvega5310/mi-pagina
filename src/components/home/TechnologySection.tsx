...
const TechnologySection = () => {
  ...
  return (
    <section className="relative z-[50] overflow-visible">
      <div className="py-12 lg:py-16 bg-gradient-to-br from-[#606aa9] to-[#aab0e8] text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 pb-12 sm:pb-16 lg:gap-16 items-start">
            {/* Left Content */}
            ...
            <div className="mt-6 lg:mt-0 lg:pt-12">
      ...
      <div className="relative -mt-16 sm:-mt-20 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {/* Card 1 */}
            <div className="bg-white rounded-lg shadow-xl overflow-hidden sm:col-span-1">
              <div className="relative h-48 sm:h-56 md:h-64">
                ...
                <div className="absolute bottom-3 sm:bottom-4 left-3 sm:left-4 right-3 sm:right-4 text-white">
                  <h3 className="text-base sm:text-lg font-bold mb-1">{t("home.section2.cards.card1.title")}</h3>
                  <p className="text-xs sm:text-sm text-gray-200">{t("home.section2.cards.card1.description")}</p>
            ...
            <div className="bg-white rounded-lg shadow-xl overflow-hidden sm:col-span-1">
              <div className="relative h-48 sm:h-56 md:h-64">
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  <h3 className="text-lg font-bold mb-1">{t("home.section2.cards.card2.title")}</h3>
                  <p className="text-sm text-gray-200">{t("home.section2.cards.card2.description")}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-xl overflow-hidden sm:col-span-2 lg:col-span-1">
              <div className="relative h-48 sm:h-56 md:h-64">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  <h3 className="text-lg font-bold mb-1">{t("home.section2.cards.card3.title")}</h3>
                  <p className="text-sm text-gray-200">{t("home.section2.cards.card3.description")}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white py-12 relative z-[1] overflow-visible">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative order-2 lg:order-1">
              ...
              />
              {/* Text overlay */}
              <div className="absolute bottom-8 left-8 bg-blue-600 text-white px-6 py-4 rounded-xl max-w-xs shadow-lg">
            ...
            <div className="space-y-8 order-1 lg:order-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700 text-sm">{t("home.section2_1.features.feature1")}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-5 h-5 rounded-full bg-green-500 flex items-center justify-center mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <p className="text-gray-700 text-sm">{t("home.section2_1.features.feature2")}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-5 h-5 rounded-full bg-green-500 flex items-center justify-center mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <p className="text-gray-700 text-sm">{t("home.section2_1.features.feature3")}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="flex-shrink-0 w-5 h-5 rounded-full bg-green-500 flex items-center justify-center mt-1">
                    <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <p className="text-gray-700 text-sm">{t("home.section2_1.features.feature4")}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Founder Info */}
                <div>
                  <h3 className="text-base font-semibold text-blue-500 leading-tight">
